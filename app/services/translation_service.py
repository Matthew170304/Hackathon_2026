...
class TranslationService:
    ...
    async def translate_to_english(
        ...
        if source_language is None or source_language == "en" or source_language not in TRANSLATABLE_LANGUAGE_CODES:
            return text
    ...
    async def _translate_with_client(self, text: str, source_language: str) -> str:
        ...
        try:
            result = self._translator.translate_to_english(text, source_language=source_language)
